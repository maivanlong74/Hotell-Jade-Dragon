...
!function(n) {
    ...
    C.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Hiển thị _START_ đến _END_ trong số _TOTAL_ thư mục",
            sInfoEmpty: "Hiển thị 0 đến 0 trong số 0 thư mục",
            sInfoFiltered: "(Lọc trước _MAX_ tổng số thư mục)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            ...
            sProcessing: "",
            sSearch: "Tìm Kiếm:",
            sSearchPlaceholder: "Mời bạn nhập tìm kiếm",
            sUrl: "",
            sZeroRecords: "Không tìm thấy kết quả"
        },
        oSearch: P.extend({}, C.models.oSearch),
        sAjaxDataProp: "Dữ liệu",
        sAjaxSource: null,
        sDom: "lfrtip",
        searchDelay: null,
    ...
    function ke(t, e, n, a) {
        var r;
        return 0 === t || t && "-" !== t ? "number" == (r = typeof t) || "bigint" == r ? t : +(t = (t = e ? G(t, e) : t).replace && (n && (t = t.replace(n, "")),
        a) ? t.replace(a, "") : t) : -1 / 0
    }
    function Me(n) {
        P.each({
